...
questions_v2 = {
    ...
    "q2": """
    Act as a Senior Technical Recruiter. Based on the analysis, provide a candid summary of the candidate's fit.
    ...
    - Content: Use the candidate's real name and contact info from the header. Highlight the 2 most relevant projects from the resume that solve problems mentioned in the JD.
    """,
    ...
    "q9": """
    Using the STAR Method (Situation, Task, Action, Result), draft a 2-minute "Elevator Pitch" for the candidate to use at the start of an interview.
    - The pitch should answer "Tell me about yourself" by weaving the resume experience into a narrative that proves they are the perfect fit for THIS job description.
    """
}
